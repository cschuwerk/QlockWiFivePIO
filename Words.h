...
#define CH_ESISCH_BM  0b1101111000000000
#define CH_ESISCH			matrix[0] |=  CH_ESISCH_BM
#define CH_ESISCH_R   matrix[0] &=  ~CH_ESISCH_BM
...
#define DE_MKF_ESIST_BM 0b1101110000000000
#define DE_MKF_ESIST		matrix[0] |= DE_MKF_ESIST_BM
#define DE_MKF_ESIST_R  matrix[0] &= ~DE_MKF_ESIST_BM
